...
export const API_ROLE_RULES: readonly ApiRule[] = [
  ...
  { prefix: "/api/mobile-access", roles: ["reception", "hotel_manager", "housekeeping", "supervisor", "owner", "super_admin"] },
  ...
  { prefix: "/api/hotel/booking-list", roles: ["reception", "hotel_manager", "supervisor", "owner", "super_admin"] },
  ...
  { prefix: "/api/staff/shifts", roles: ["staff", "supervisor", "owner", "super_admin", "hotel_manager", "reception", "housekeeping"] },
  { prefix: "/api/staff", roles: ["staff", "supervisor", "owner", "super_admin", "hotel_manager", "reception", "housekeeping"] },
  ...
  { prefix: "/api/shift-plans", roles: ["cucina", "pizzeria", "bar", "sala", "supervisor", "owner", "super_admin", "hotel_manager", "reception", "housekeeping"] },
