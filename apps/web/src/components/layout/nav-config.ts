...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        hint: "Documenti, upload, indicizzazione RAG per tenant.",
        href: "/ai-knowledge-base",
        icon: Database,
        ready: true,
        visibleFor: ["owner", "supervisor", "super_admin", "hotel_manager", "reception"],
      },
      {
        id: "ai-rag-dashboard",
        label: "Dashboard RAG",
        hint: "Statistiche vector DB, embedding, ricerca semantica.",
        href: "/ai-rag-dashboard",
        icon: Sparkles,
        ready: true,
        visibleFor: ["owner", "supervisor", "super_admin"],
      },
      ...
      },
      {
        id: "risto-comandi",
        label: "Risto Comandi",
        hint: "Comandi vocali per gestire tutto il ristorante.",
        href: "/risto-comandi",
        icon: Mic,
        ready: true,
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "hotel-rate-plans",
        label: "Listini",
        hint: "Tariffe per tipo camera e trattamento (IVA inclusa).",
        href: "/hotel/rate-plans",
        icon: Tags,
        ready: true,
        vertical: "hotel",
        feature: "hotel",
        visibleFor: ["hotel_manager", "owner", "super_admin"],
      },
      {
        id: "hotel-planner",
      ...
      {
        id: "hotel-booking-list",
        label: "Lista Prenotazioni",
        hint: "Foglio unico: online, desk, agenzia, voucher — conferma e check-in.",
        href: "/hotel/booking-list",
        icon: ClipboardList,
        ready: true,
        vertical: "hotel",
        feature: "hotel",
      ...
      {
        id: "hotel-mobile-access",
        label: "Key & Mobile Access",
        hint: "KeyKARD — Mobile Key, wallet e provider serrature.",
        href: "/hotel/mobile-access",
        icon: Smartphone,
        ready: true,
        vertical: "hotel",
        feature: "hotel",
        visibleFor: ["reception", "hotel_manager", "housekeeping", "supervisor", "owner", "super_admin"],
      },
      {
        id: "hotel-folio",
        label: "Guest Folio",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "cantina",
        label: "Cantina",
        hint: "Carta dei vini, annate e prezzi.",
        href: "/cantina",
        icon: Grape,
        ready: true,
        vertical: "restaurant",
