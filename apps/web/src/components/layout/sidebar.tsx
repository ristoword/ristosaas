  ...
  return (
    <>
      <aside
        ...
        data-sidebar="true"
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex w-[min(18.5rem,88vw)] flex-col border-r border-white/10 bg-rw-sidebar text-white shadow-rw transition-transform duration-rw no-print",
