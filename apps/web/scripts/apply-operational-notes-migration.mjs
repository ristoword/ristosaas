/**
 * Applica prisma/migrations_add_operational_notes.sql
 * Crea la tabella OperationalNote per le note operative persistite
 * di pizzeria, bar, cucina e sala.
 *
 * Uso: da apps/web → node scripts/apply-operational-notes-migration.mjs
 */
...
const SQL_PATH = resolve(WEB_ROOT, "prisma/migrations_add_operational_notes.sql");
