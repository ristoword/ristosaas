...
const TENANT_NAME = process.env.NEXT_PUBLIC_TENANT_NAME || "RistoSimply";
...
async function upsertCustomers() {
  const customers = [
    ...
    { id: "cst_5", name: "Elena Costa", email: "elena@email.it", phone: "+39 333 5555555", type: "new", visits: 0, totalSpent: 0, avgSpend: 0, allergies: "", preferences: "", notes: "Agenzia Travel World", lastVisit: null },
    { id: "cst_6", name: "Paolo Neri", email: "paolo@email.it", phone: "+39 333 6666666", type: "new", visits: 0, totalSpent: 0, avgSpend: 0, allergies: "", preferences: "", notes: "Voucher regalo", lastVisit: null },
  ];
  await Promise.all(
...
async function upsertReservations(roomCodeToId) {
  ...
  const reservations = [
    ...
    },
    {
      ...
      customerId: "cst_4",
      roomId: null,
      guestName: "Marco Ferretti",
      phone: "+39 333 4444444",
      email: "marco@email.it",
      checkInDate: fmt(addDays(today, 1)),
      checkOutDate: fmt(addDays(today, 3)),
      guests: 2,
      status: "in_attesa",
      roomType: "Classic",
      boardType: "bed_breakfast",
    ...
    },
    {
      ...
      customerId: "cst_5",
      roomId: null,
      guestName: "Elena Costa",
      phone: "+39 333 5555555",
      email: "elena@email.it",
      checkInDate: fmt(addDays(today, 4)),
      checkOutDate: fmt(addDays(today, 7)),
      guests: 2,
      status: "in_attesa",
      roomType: "Superior",
      boardType: "half_board",
      ...
      documentCode: "",
      channel: "agency",
      company: "Travel World Srl",
    },
    {
      id: "res_voucher_1",
      customerId: "cst_6",
      roomId: null,
      guestName: "Paolo Neri",
      phone: "+39 333 6666666",
      email: "paolo@email.it",
      checkInDate: fmt(addDays(today, 5)),
      checkOutDate: fmt(addDays(today, 8)),
      guests: 1,
      status: "confermata",
      roomType: "Classic",
      boardType: "room_only",
      nights: 3,
      rate: 90,
      documentCode: "PN112233",
      channel: "voucher",
      voucherCode: "GIFT-2026-0042",
    },
    {
      id: "res_4",
      customerId: "cst_2",
    ...
    reservations.map((reservation) =>
      prisma.hotelReservation.upsert({
        ...
        update: {
          ...
          channel: reservation.channel ?? "desk",
          voucherCode: reservation.voucherCode ?? null,
          company: reservation.company ?? null,
        },
        create: {
          id: reservation.id,
          tenantId: TENANT_ID,
  ...
  for (const p of partners) {
    await prisma.partner.upsert({
      ...
      update: {
        ...
        notes: p.notes,
        active: p.active,
        ...(p.partnerKind ? { partnerKind: p.partnerKind } : {}),
      },
      create: p,
    });
  }
